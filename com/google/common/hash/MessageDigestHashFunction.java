...
/*     */ 
/*     */   
/*  66 */   public int bits() { return this.bytes * 8; }
/*     */ 
/*     */ 
/*     */   
/*  70 */   public String toString() { return this.toString; }
/*     */ 
/*     */   
...
/*     */     
/* 104 */     private Object readResolve() { return new MessageDigestHashFunction(this.algorithmName, this.bytes, this.toString); }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 111 */   Object writeReplace() { return new SerializedForm(this.prototype.getAlgorithm(), this.bytes, this.toString, null); }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 147 */     private void checkNotDone() { Preconditions.checkState(!this.done, "Cannot re-use a Hasher after calling hash() on it"); }
/*     */ 
/*     */ 
/*     */     
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/hash/MessageDigestHashFunction.class

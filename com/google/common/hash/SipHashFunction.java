...
/*     */ 
/*     */   
/*  64 */   public int bits() { return 64; }
/*     */ 
/*     */ 
/*     */   
/*  68 */   public Hasher newHasher() { return new SipHasher(this.c, this.d, this.k0, this.k1); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  74 */   public String toString() { return "Hashing.sipHash" + this.c + "" + this.d + "(" + this.k0 + ", " + this.k1 + ")"; }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  91 */   public int hashCode() { return (int)((getClass().hashCode() ^ this.c ^ this.d) ^ this.k0 ^ this.k1); }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/hash/SipHashFunction.class

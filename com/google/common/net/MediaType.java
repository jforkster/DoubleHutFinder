...
/*     */ 
/*     */   
/* 111 */   private static MediaType createConstant(String type, String subtype) { return addKnownType(new MediaType(type, subtype, ImmutableListMultimap.of())); }
/*     */ 
/*     */ 
/*     */   
/* 115 */   private static MediaType createConstantUtf8(String type, String subtype) { return addKnownType(new MediaType(type, subtype, UTF_8_CONSTANT_PARAMETERS)); }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 361 */   public String type() { return this.type; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 366 */   public String subtype() { return this.subtype; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 371 */   public ImmutableListMultimap<String, String> parameters() { return this.parameters; }
/*     */ 
/*     */   
/*     */   private Map<String, ImmutableMultiset<String>> parametersAsMap() {
/* 375 */     return Maps.transformValues(this.parameters.asMap(), new Function<Collection<String>, ImmutableMultiset<String>>()
/*     */         {
...
/* 392 */     ImmutableSet<String> charsetValues = ImmutableSet.copyOf(this.parameters.get("charset"));
/* 393 */     switch (charsetValues.size()) {
/*     */       case 0:
/* 395 */         return Optional.absent();
/*     */       case 1:
/* 397 */         return Optional.of(Charset.forName((String)Iterables.getOnlyElement(charsetValues)));
/*     */     } 
...
/*     */ 
/*     */   
/* 408 */   public MediaType withoutParameters() { return this.parameters.isEmpty() ? this : create(this.type, this.subtype); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 417 */   public MediaType withParameters(Multimap<String, String> parameters) { return create(this.type, this.subtype, parameters); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 433 */     for (Map.Entry<String, String> entry : this.parameters.entries()) {
...
/*     */ 
/*     */   
/* 461 */   public boolean hasWildcard() { return ("*".equals(this.type) || "*".equals(this.subtype)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 491 */   public boolean is(MediaType mediaTypeRange) { return ((mediaTypeRange.type.equals("*") || mediaTypeRange.type.equals(this.type)) && (mediaTypeRange.subtype.equals("*") || mediaTypeRange.subtype.equals(this.subtype)) && this.parameters.entries().containsAll(mediaTypeRange.parameters.entries())); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 503 */   public static MediaType create(String type, String subtype) { return create(type, subtype, ImmutableListMultimap.of()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 512 */   static MediaType createApplicationType(String subtype) { return create("application", subtype); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 521 */   static MediaType createAudioType(String subtype) { return create("audio", subtype); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 530 */   static MediaType createImageType(String subtype) { return create("image", subtype); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 539 */   static MediaType createTextType(String subtype) { return create("text", subtype); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 548 */   static MediaType createVideoType(String subtype) { return create("video", subtype); }
/*     */ 
/*     */ 
/*     */   
...
/* 561 */     for (Map.Entry<String, String> entry : parameters.entries()) {
/* 562 */       String attribute = normalizeToken((String)entry.getKey());
/* 563 */       builder.put(attribute, normalizeParameterValue(attribute, (String)entry.getValue()));
/*     */     } 
...
/*     */ 
/*     */   
/* 576 */   private static String normalizeParameterValue(String attribute, String value) { return "charset".equals(attribute) ? Ascii.toLowerCase(value) : value; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/*     */   }
/*     */   private static final class Tokenizer { final String input;
/*     */     
...
/*     */ 
/*     */     
/* 665 */     boolean hasMore() { return (this.position >= 0 && this.position < this.input.length()); } }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 684 */   public int hashCode() { return Objects.hashCode(new Object[] { this.type, this.subtype, parametersAsMap() }); }
/*     */ 
/*     */   
...
/* 696 */       builder.append("; ");
/* 697 */       ListMultimap listMultimap = Multimaps.transformValues(this.parameters, new Function<String, String>()
/*     */           {
/*     */             public String apply(String value) {
/* 700 */               return TOKEN_MATCHER.matchesAllOf(value) ? value : MediaType.escapeAndQuote(value);
/*     */             }
/*     */           });
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/net/MediaType.class

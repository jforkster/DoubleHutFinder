...
/*      */ 
/*      */   
/*  168 */   public static boolean isInetAddress(String ipString) { return (ipStringToBytes(ipString) != null); }
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/*  231 */     int skipIndex = -1; int partsHi;
/*  232 */     for (partsHi = 1; partsHi < parts.length - 1; partsHi++) {
/*  233 */       if (parts[partsHi].length() == 0) {
/*  234 */         if (skipIndex >= 0) {
/*  235 */           return null;
/*      */         }
/*  237 */         skipIndex = partsHi;
/*      */       } 
/*      */     } 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/*  649 */       this.server = (Inet4Address)Objects.firstNonNull(server, ANY4);
/*  650 */       this.client = (Inet4Address)Objects.firstNonNull(client, ANY4);
/*  651 */       this.port = port;
/*  652 */       this.flags = flags;
/*      */     }
/*      */ 
/*      */     
/*  656 */     public Inet4Address getServer() { return this.server; }
/*      */ 
/*      */ 
/*      */     
/*  660 */     public Inet4Address getClient() { return this.client; }
/*      */ 
/*      */ 
/*      */     
/*  664 */     public int getPort() { return this.port; }
/*      */ 
/*      */ 
/*      */     
/*  668 */     public int getFlags() { return this.flags; }
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  778 */   public static boolean hasEmbeddedIPv4ClientAddress(Inet6Address ip) { return (isCompatIPv4Address(ip) || is6to4Address(ip) || isTeredoAddress(ip)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  938 */   public static int coerceToInteger(InetAddress ip) { return ByteStreams.newDataInput(getCoercedIPv4Address(ip).getAddress()).readInt(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  949 */   public static Inet4Address fromInteger(int address) { return getInet4Address(Ints.toByteArray(address)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/net/InetAddresses.class

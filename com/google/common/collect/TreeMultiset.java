...
/*     */   
/*  74 */   public static <E extends Comparable> TreeMultiset<E> create() { return new TreeMultiset(Ordering.natural()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  91 */   public static <E> TreeMultiset<E> create(@Nullable Comparator<? super E> comparator) { return (comparator == null) ? new TreeMultiset(Ordering.natural()) : new TreeMultiset(comparator); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   private final abstract enum Aggregate
/*     */   {
/*     */     SIZE, DISTINCT;
/*     */ 
/*     */ 
...
/*     */     static  {
/*     */       // Byte code:
/*     */       //   0: new com/google/common/collect/TreeMultiset$Aggregate$1
/*     */       //   3: dup
/*     */       //   4: ldc 'SIZE'
/*     */       //   6: iconst_0
/*     */       //   7: invokespecial <init> : (Ljava/lang/String;I)V
/*     */       //   10: putstatic com/google/common/collect/TreeMultiset$Aggregate.SIZE : Lcom/google/common/collect/TreeMultiset$Aggregate;
/*     */       //   13: new com/google/common/collect/TreeMultiset$Aggregate$2
/*     */       //   16: dup
/*     */       //   17: ldc 'DISTINCT'
/*     */       //   19: iconst_1
/*     */       //   20: invokespecial <init> : (Ljava/lang/String;I)V
/*     */       //   23: putstatic com/google/common/collect/TreeMultiset$Aggregate.DISTINCT : Lcom/google/common/collect/TreeMultiset$Aggregate;
/*     */       //   26: iconst_2
/*     */       //   27: anewarray com/google/common/collect/TreeMultiset$Aggregate
/*     */       //   30: dup
/*     */       //   31: iconst_0
/*     */       //   32: getstatic com/google/common/collect/TreeMultiset$Aggregate.SIZE : Lcom/google/common/collect/TreeMultiset$Aggregate;
/*     */       //   35: aastore
/*     */       //   36: dup
/*     */       //   37: iconst_1
/*     */       //   38: getstatic com/google/common/collect/TreeMultiset$Aggregate.DISTINCT : Lcom/google/common/collect/TreeMultiset$Aggregate;
/*     */       //   41: aastore
/*     */       //   42: putstatic com/google/common/collect/TreeMultiset$Aggregate.$VALUES : [Lcom/google/common/collect/TreeMultiset$Aggregate;
/*     */       //   45: return
/*     */       // Line number table:
...
/*     */ 
/*     */   
/* 219 */   public int size() { return Ints.saturatedCast(aggregateForEntries(Aggregate.SIZE)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 224 */   int distinctElements() { return Ints.saturatedCast(aggregateForEntries(Aggregate.DISTINCT)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 344 */           if (result == 0) {
/* 345 */             return super.this$0.count(super.getElement());
/*     */           }
/* 347 */           return result;
/*     */         }
/*     */       };
...
/* 357 */     AvlNode<E> node, root = (AvlNode)this.rootReference.get();
/* 358 */     if (root == null) {
/* 359 */       return null;
/*     */     }
/*     */     
/* 362 */     if (this.range.hasLowerBound()) {
/* 363 */       E endpoint = (E)this.range.getLowerEndpoint();
...
/* 379 */     AvlNode<E> node, root = (AvlNode)this.rootReference.get();
/* 380 */     if (root == null) {
/* 381 */       return null;
/*     */     }
/*     */     
/* 384 */     if (this.range.hasUpperBound()) {
/* 385 */       E endpoint = (E)this.range.getUpperEndpoint();
...
/* 402 */     return new Iterator<Multiset.Entry<E>>()
/*     */       {
/*     */         TreeMultiset.AvlNode<E> current;
/*     */         Multiset.Entry<E> prevEntry;
/*     */         
/*     */         public boolean hasNext() {
/* 408 */           if (super.current == null)
/* 409 */             return false; 
/* 410 */           if (super.this$0.range.tooHigh(super.current.getElement())) {
/* 411 */             super.current = null;
/* 412 */             return false;
/*     */           } 
/* 414 */           return true;
/*     */         }
...
/* 420 */           if (!super.hasNext()) {
/* 421 */             throw new NoSuchElementException();
/*     */           }
/* 423 */           Multiset.Entry<E> result = super.this$0.wrapEntry(super.current);
/* 424 */           super.prevEntry = result;
/* 425 */           if (super.current.succ == super.this$0.header) {
/* 426 */             super.current = null;
/*     */           } else {
/* 428 */             super.current = super.current.succ;
/*     */           } 
/* 430 */           return result;
/*     */         }
/*     */ 
/*     */         
/*     */         public void remove() {
/* 435 */           CollectPreconditions.checkRemove((super.prevEntry != null));
/* 436 */           super.this$0.setCount(super.prevEntry.getElement(), 0);
/* 437 */           super.prevEntry = null;
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 444 */     return new Iterator<Multiset.Entry<E>>()
/*     */       {
/*     */         TreeMultiset.AvlNode<E> current;
/*     */         Multiset.Entry<E> prevEntry;
/*     */         
/*     */         public boolean hasNext() {
/* 450 */           if (super.current == null)
/* 451 */             return false; 
/* 452 */           if (super.this$0.range.tooLow(super.current.getElement())) {
/* 453 */             super.current = null;
/* 454 */             return false;
/*     */           } 
/* 456 */           return true;
/*     */         }
...
/*     */         
/*     */         public Multiset.Entry<E> next() {
/* 462 */           if (!super.hasNext()) {
/* 463 */             throw new NoSuchElementException();
/*     */           }
/* 465 */           Multiset.Entry<E> result = super.this$0.wrapEntry(super.current);
/* 466 */           super.prevEntry = result;
/* 467 */           if (super.current.pred == super.this$0.header) {
/* 468 */             super.current = null;
/*     */           } else {
/* 470 */             super.current = super.current.pred;
/*     */           } 
/* 472 */           return result;
/*     */         }
/*     */ 
/*     */         
/*     */         public void remove() {
/* 477 */           CollectPreconditions.checkRemove((super.prevEntry != null));
/* 478 */           super.this$0.setCount(super.prevEntry.getElement(), 0);
/* 479 */           super.prevEntry = null;
/*     */         }
/*     */       };
/*     */   }
/*     */ 
/*     */ 
/*     */   
/* 486 */   public SortedMultiset<E> headMultiset(@Nullable E upperBound, BoundType boundType) { return new TreeMultiset(this.rootReference, this.range.intersect(GeneralRange.upTo(comparator(), upperBound, boundType)), this.header); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 494 */   public SortedMultiset<E> tailMultiset(@Nullable E lowerBound, BoundType boundType) { return new TreeMultiset(this.rootReference, this.range.intersect(GeneralRange.downTo(comparator(), lowerBound, boundType)), this.header); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   private static final class Reference<T> extends Object {
/*     */     @Nullable
/*     */     private T value;
/*     */     
/*     */     @Nullable
...
/*     */ 
/*     */     
/* 837 */     private void recomputeHeight() { this.height = 1 + Math.max(height(this.left), height(this.right)); }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 864 */     private int balanceFactor() { return height(this.left) - height(this.right); }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 892 */     private static long totalCount(@Nullable AvlNode<?> node) { return (node == null) ? 0L : node.totalCount; }
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 923 */     public E getElement() { return (E)this.elem; }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 928 */     public int getCount() { return this.elemCount; }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 933 */     public String toString() { return Multisets.immutableEntry(getElement(), getCount()).toString(); }
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/collect/TreeMultiset.class

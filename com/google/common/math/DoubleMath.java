...
/* 183 */     if (((-9.223372036854776E18D - x < 1.0D) ? 1 : 0) & ((x < 9.223372036854776E18D) ? 1 : 0)) {
...
/* 198 */   public static boolean isPowerOfTwo(double x) { return (x > 0.0D && DoubleUtils.isFinite(x) && LongMath.isPowerOfTwo(DoubleUtils.getSignificand(x))); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 217 */   public static double log2(double x) { return Math.log(x) / LN_2; }
/*     */ 
/*     */   
...
/*     */   
/*     */   @GwtIncompatible("java.lang.Math.getExponent, com.google.common.math.DoubleUtils")
/* 280 */   public static boolean isMathematicalInteger(double x) { return (DoubleUtils.isFinite(x) && (x == 0.0D || 52 - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(x)) <= Math.getExponent(x))); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 313 */       1.0D, 2.0922789888E13D, 2.631308369336935E35D, 1.2413915592536073E61D, 1.2688693218588417E89D, 7.156945704626381E118D, 9.916779348709496E149D, 1.974506857221074E182D, 3.856204823625804E215D, 5.5502938327393044E249D, 4.7147236359920616E284D };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/math/DoubleMath.class

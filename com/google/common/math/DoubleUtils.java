...
/*     */   
/*  40 */   static double nextDown(double d) { return -Math.nextUp(-d); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  69 */     return (exponent == -1023) ? (bits << true) : (bits | 0x10000000000000L);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  75 */   static boolean isFinite(double d) { return (Math.getExponent(d) <= 1023); }
/*     */ 
/*     */ 
/*     */   
/*  79 */   static boolean isNormal(double d) { return (Math.getExponent(d) >= -1022); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 112 */     long signifFloor = twiceSignifFloor >> true;
...
/*     */ 
/*     */     
/* 131 */     bits |= x.signum() & Float.MIN_VALUE;
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/math/DoubleUtils.class

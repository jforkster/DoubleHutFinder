...
/*     */   
/*  63 */   public static boolean isPowerOfTwo(int x) { return ((x > 0) ? 1 : 0) & (((x & x - 1) == 0) ? 1 : 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @VisibleForTesting
/*  75 */   static int lessThanBranchFree(int x, int y) { return (x - y ^ 0xFFFFFFFF ^ 0xFFFFFFFF) >>> 31; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 169 */       9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0, 0 };
/*     */   
/*     */   @VisibleForTesting
...
/* 195 */         return 1;
/*     */       case -1:
/* 197 */         return ((k & true) == 0) ? 1 : -1;
/*     */       case 2:
/* 199 */         return (k < 32) ? (1 << k) : 0;
/*     */       case -2:
/* 201 */         if (k < 32) {
/* 202 */           return ((k & true) == 0) ? (1 << k) : -(1 << k);
/*     */         }
/* 204 */         return 0;
/*     */     } 
/*     */ 
...
/*     */ 
/*     */   
/* 267 */   private static int sqrtFloor(int x) { return (int)Math.sqrt(x); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int divide(int p, int q, RoundingMode mode) { // Byte code:
/*     */     //   0: aload_2
...
/* 502 */       1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 550 */       Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 580 */   public static int mean(int x, int y) { return (x & y) + ((x ^ y) >> 1); }
/*     */ }


/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/math/IntMath.class

...
/*     */   
/*  62 */   public static boolean isPowerOfTwo(long x) { return ((x > 0L) ? 1 : 0) & (((x & x - 1L) == 0L) ? 1 : 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @VisibleForTesting
/*  73 */   static int lessThanBranchFree(long x, long y) { return (int)((x - y ^ 0xFFFFFFFFFFFFFFFFL ^ 0xFFFFFFFFFFFFFFFFL) >>> 63); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 169 */       19, 18, 18, 18, 18, 17, 17, 17, 16, 16, 16, 15, 15, 15, 15, 14, 14, 14, 13, 13, 13, 12, 12, 12, 12, 11, 11, 11, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0 };
/*     */ 
/*     */ 
/*     */   
/*     */   @GwtIncompatible("TODO")
...
/* 176 */       1L, 10L, 100L, 1000L, 10000L, 100000L, 1000000L, 10000000L, 100000000L, 1000000000L, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 201 */       3L, 31L, 316L, 3162L, 31622L, 316227L, 3162277L, 31622776L, 316227766L, 3162277660L, 31622776601L, 316227766016L, 3162277660168L, 31622776601683L, 316227766016837L, 3162277660168379L, 31622776601683793L, 316227766016837933L, 3162277660168379331L };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 238 */           return 1L;
/*     */         case -1:
/* 240 */           return ((k & true) == 0) ? 1L : -1L;
/*     */         case 2:
/* 242 */           return (k < 64) ? (1L << k) : 0L;
/*     */         case -2:
/* 244 */           if (k < 64) {
/* 245 */             return ((k & true) == 0) ? (1L << k) : -(1L << k);
/*     */           }
/* 247 */           return 0L;
/*     */       } 
/*     */       
...
/*     */       case HALF_UP:
/*     */       case HALF_EVEN:
/* 319 */         sqrtFloor = guess - ((x < guessSquared) ? true : false);
...
/*     */     long cmpRemToHalfDivisor, absRem;
/*     */     boolean increment, increment;
...
/*     */ 
/*     */     
/* 363 */     int signum = true | (int)((p ^ q) >> 63);
/*     */     
/* 365 */     switch (mode) {
/*     */       case UNNECESSARY:
...
/* 389 */           increment = ((mode == RoundingMode.HALF_UP) ? 1 : 0) | ((mode == RoundingMode.HALF_EVEN) ? 1 : 0) & (((div & 0x1L) != 0L) ? 1 : 0); break;
/*     */         } 
...
/*     */   
/*     */   @GwtIncompatible("TODO")
/* 421 */   public static int mod(long x, int m) { return (int)mod(x, m); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 550 */     MathPreconditions.checkNoOverflow(((a >= 0L) ? 1 : 0) | ((b != Float.MIN_VALUE) ? 1 : 0));
/* 551 */     long result = a * b;
...
/* 615 */     return (n < factorials.length) ? factorials[n] : Float.MAX_VALUE;
/*     */   }
/*     */   static final long[] factorials = { 
/* 618 */       1L, 1L, 2L, 6L, 24L, 120L, 720L, 5040L, 40320L, 362880L, 3628800L, 39916800L, 479001600L, 6227020800L, 87178291200L, 1307674368000L, 20922789888000L, 355687428096000L, 6402373705728000L, 121645100408832000L, 2432902008176640000L };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 727 */       Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 736 */       Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 744 */   static boolean fitsInInt(long x) { return ((int)x == x); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 757 */   public static long mean(long x, long y) { return (x & y) + ((x ^ y) >> true); }
/*     */ }


/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/math/LongMath.class

...
/*     */ {
/*  47 */   public static String nullToEmpty(@Nullable String string) { return (string == null) ? "" : string; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Nullable
/*  58 */   public static String emptyToNull(@Nullable String string) { return isNullOrEmpty(string) ? null : string; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  75 */   public static boolean isNullOrEmpty(@Nullable String string) { return (string == null || string.length() == 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @VisibleForTesting
/* 234 */   static boolean validSurrogatePairAt(CharSequence string, int index) { return (index >= 0 && index <= string.length() - 2 && Character.isHighSurrogate(string.charAt(index)) && Character.isLowSurrogate(string.charAt(index + 1))); }
/*     */ }


/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/base/Strings.class

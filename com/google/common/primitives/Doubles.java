...
/*     */   
/*  74 */   public static int hashCode(double value) { return Double.valueOf(value).hashCode(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  96 */   public static int compare(double a, double b) { return Double.compare(a, b); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 107 */   public static boolean isFinite(double value) { return ((Double.NEGATIVE_INFINITY < value) ? 1 : 0) & ((value < Double.POSITIVE_INFINITY) ? 1 : 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 140 */   public static int indexOf(double[] array, double target) { return indexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 198 */   public static int lastIndexOf(double[] array, double target) { return lastIndexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */     
/* 277 */     protected Double doForward(String value) { return Double.valueOf(value); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 282 */     protected String doBackward(Double value) { return value.toString(); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 287 */     public String toString() { return "Doubles.stringConverter()"; }
/*     */ 
/*     */ 
/*     */     
/* 291 */     private Object readResolve() { return INSTANCE; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Beta
/* 304 */   public static Converter<String, Double> stringConverter() { return DoubleConverter.INSTANCE; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 385 */   public static Comparator<double[]> lexicographicalComparator() { return LexicographicalComparator.INSTANCE; }
/*     */   
...
/*     */     
/* 466 */     DoubleArrayAsList(double[] array) { this(array, 0, array.length); }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 476 */     public int size() { return this.end - this.start; }
/*     */ 
/*     */ 
/*     */     
/* 480 */     public boolean isEmpty() { return false; }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 490 */     public boolean contains(Object target) { return (target instanceof Double && Doubles.indexOf(this.array, ((Double)target).doubleValue(), this.start, this.end) != -1); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/primitives/Doubles.class

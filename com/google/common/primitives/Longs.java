...
/*     */   
/*  78 */   public static int hashCode(long value) { return (int)(value ^ value >>> 32); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  94 */   public static int compare(long a, long b) { return (a < b) ? -1 : ((a > b) ? 1 : 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 125 */   public static int indexOf(long[] array, long target) { return indexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 179 */   public static int lastIndexOf(long[] array, long target) { return lastIndexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 305 */   public static long fromBytes(byte b1, byte b2, byte b3, byte b4, byte b5, byte b6, byte b7, byte b8) { return (b1 & 0xFFL) << 56 | (b2 & 0xFFL) << 48 | (b3 & 0xFFL) << 40 | (b4 & 0xFFL) << 32 | (b5 & 0xFFL) << 24 | (b6 & 0xFFL) << 16 | (b7 & 0xFFL) << 8 | b8 & 0xFFL; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       }
/* 355 */       accum *= 10L;
/* 356 */       if (accum < Float.MIN_VALUE + digit) {
/* 357 */         return null;
/*     */       }
/* 359 */       accum -= digit;
/*     */     } 
...
/*     */     
/* 376 */     protected Long doForward(String value) { return Long.decode(value); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 381 */     protected String doBackward(Long value) { return value.toString(); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 386 */     public String toString() { return "Longs.stringConverter()"; }
/*     */ 
/*     */ 
/*     */     
/* 390 */     private Object readResolve() { return INSTANCE; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Beta
/* 403 */   public static Converter<String, Long> stringConverter() { return LongConverter.INSTANCE; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 479 */   public static Comparator<long[]> lexicographicalComparator() { return LexicographicalComparator.INSTANCE; }
/*     */   
...
/*     */     
/* 557 */     LongArrayAsList(long[] array) { this(array, 0, array.length); }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 567 */     public int size() { return this.end - this.start; }
/*     */ 
/*     */ 
/*     */     
/* 571 */     public boolean isEmpty() { return false; }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 581 */     public boolean contains(Object target) { return (target instanceof Long && Longs.indexOf(this.array, ((Long)target).longValue(), this.start, this.end) != -1); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/primitives/Longs.class

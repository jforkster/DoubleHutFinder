...
/*     */   
/*  74 */   public static int hashCode(float value) { return Float.valueOf(value).hashCode(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  92 */   public static int compare(float a, float b) { return Float.compare(a, b); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 103 */   public static boolean isFinite(float value) { return ((Float.NEGATIVE_INFINITY < value) ? 1 : 0) & ((value < Float.POSITIVE_INFINITY) ? 1 : 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 136 */   public static int indexOf(float[] array, float target) { return indexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 194 */   public static int lastIndexOf(float[] array, float target) { return lastIndexOf(array, target, 0, array.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */     
/* 273 */     protected Float doForward(String value) { return Float.valueOf(value); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 278 */     protected String doBackward(Float value) { return value.toString(); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 283 */     public String toString() { return "Floats.stringConverter()"; }
/*     */ 
/*     */ 
/*     */     
/* 287 */     private Object readResolve() { return INSTANCE; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Beta
/* 300 */   public static Converter<String, Float> stringConverter() { return FloatConverter.INSTANCE; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 381 */   public static Comparator<float[]> lexicographicalComparator() { return LexicographicalComparator.INSTANCE; }
/*     */   
...
/*     */     
/* 462 */     FloatArrayAsList(float[] array) { this(array, 0, array.length); }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 472 */     public int size() { return this.end - this.start; }
/*     */ 
/*     */ 
/*     */     
/* 476 */     public boolean isEmpty() { return false; }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 486 */     public boolean contains(Object target) { return (target instanceof Float && Floats.indexOf(this.array, ((Float)target).floatValue(), this.start, this.end) != -1); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* Location:              /Users/jfoster/Desktop/DoubleHutFinder_1_13_by_Vales.jar!/com/google/common/primitives/Floats.class
